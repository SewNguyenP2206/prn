...
namespace BussinessObjects.Migrations
{
    ...
    public partial class Update3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChannelRolePermissions_Channels_ChannelId1",
                        column: x => x.ChannelId1,
                        principalTable: "Channels",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChannelRolePermissions_Permission_PermissionId",
                        column: x => x.PermissionId,
                        principalTable: "Permission",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChannelRolePermissions_Permission_PermissionId1",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChannelRolePermissions_Roles_RoleId1",
                        column: x => x.RoleId1,
                        principalTable: "Roles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelRolePermissions_ChannelId1",
                table: "ChannelRolePermissions",
                column: "ChannelId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelRolePermissions_PermissionId1",
                table: "ChannelRolePermissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelRolePermissions_RoleId1",
                table: "ChannelRolePermissions",
                column: "RoleId1");
